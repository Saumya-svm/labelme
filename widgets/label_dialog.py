...
class LabelDialog(QtWidgets.QDialog):
    def __init__(
        ...
        self.character7.addItem("Select Lighting Condition")
        self.character7.addItem("Naturally Lit")
        self.character7.addItem("Poor Illumination")
        self.character7.addItem("External Light Exposure")
    ...
    def popUp(self, text=None, move=True, flags=None, group_id=None, description=None, character=None):
        ...
        if character is None:
            character = ""
        try:
            self.character.setEditText(character)
        except:
            self.character.setEditText(character[0])
